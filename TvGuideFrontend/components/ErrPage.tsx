                ...
                <div className="row mx-0">
                    <div className="col-md-6 align-self-center text order-md-1 order-2">
                        <div className="p-3">
                            ...
                            <button className="btn rounded-pill btn-primary fs-sm fw-bold py-2 px-4">Go to Home</button>
                        </div>
                    </div>
                    <div className="col-md-6 order-md-2 order-1">
                        <Image src={CommonFunctions.FormatImageSrc(errorImg)} alt="error" layout="responsive" />
                    </div>
                </div>
            </div>
        </>
